...
class Phone extends Component {
  ...
  addToCart = (productId) => {
    ...
    if (this.props.user.msg) {
      ...
      Axios.post(`${appConfig.apiUrl}/cart/addtocart`, {
        userId: this.props.user._id,
        products: [
          {
            productId: this.props.match.params.id,
            name: phoneInfo.phone.product.name,
            price: phoneInfo.phone.product.price,
            count: 1,
          },
        ],
      });
  ...
  render() {
    ...
    return (
      <div>
        ...
        <h3 className="border-bottom d-flex align-items-center pt-2">
          {phone ? phone.product.name : ""}
        </h3>
        <Row>
          <Col xs="12" sm="4">
            <Row>
              <img
                ...
                src={
                  phone
                    ? `${appConfig.apiProductImage}/${phone.product.image}`
                    : ""
                }
              ></img>
            </Row>
            ...
            <Row>
              ...
              >
                <FormattedNumber value={phone ? phone.product.price : ""} /> đ
              </span>
            </Row>
          </Col>
            ...
            <Form onSubmit={(e) => this.onSubmitComment(e)}>
              <FormGroup className="form-group-comment">
                ...
                <Input
                  ...
                  id="exampleText"
                />
                <Button className="btn-send-comment" outline color="dark">
                  Gửi
                </Button>
              </FormGroup>
            </Form>
                ...
                <Table>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {phone.productDetail.screen
                          ? phone.productDetail.screen.screenTechnology
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      <td>Hệ điều hành</td>
                      <td>
                        {phone.productDetail.platform
                          ? phone.productDetail.platform.os
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      <td>Camera trước</td>
                      <td>
                        {phone.productDetail.selfieCamera
                          ? phone.productDetail.selfieCamera.resolution
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      <td>Camera sau</td>
                      <td>
                        {phone.productDetail.mainCamera
                          ? phone.productDetail.mainCamera.resolution
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        {phone.productDetail.platform
                          ? phone.productDetail.platform.cpu
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      <td>RAM</td>
                      <td>
                        {phone.productDetail.memory
                          ? phone.productDetail.memory.ram
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        {phone.productDetail.memory
                          ? phone.productDetail.memory.rom
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        {phone.productDetail.memory
                          ? phone.productDetail.memory.cardSlot
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      <td>Thẻ SIM</td>
                      <td>
                        {phone.productDetail.comms
                          ? phone.productDetail.comms.sim
                          : ""}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        {phone.productDetail.battery
                          ? phone.productDetail.battery.capacity
                          : ""}
                      </td>
                    </tr>
                  </tbody>
          ...
          <Col xs="12" sm="8">
            <div className="d-flex mb-2">
              ...
              <div className="ml-auto d-flex">
                ...
                <Dropdown
                  isOpen={isOpenDropdownAnalysis}
                  toggle={this.toggleDropdownAnalysis}
                >
                  <DropdownToggle caret>
                    {params.analysis ? params.analysis : "Tất cả"}
                  </DropdownToggle>
                  <DropdownMenu className="">
                    <DropdownItem onClick={(e) => this.onClickSelectAnalysis()}>
                      Tất cả
                    </DropdownItem>
                    <DropdownItem
                      onClick={(e) => this.onClickSelectAnalysis("tích cực")}
                    >
                      Tích cực
                    </DropdownItem>
                    <DropdownItem
                      onClick={(e) => this.onClickSelectAnalysis("tiêu cực")}
                    >
                      Tiêu cực
                    </DropdownItem>
                    <DropdownItem
                      onClick={(e) => this.onClickSelectAnalysis("bình thường")}
                    >
                      Bình thường
                    </DropdownItem>
                  </DropdownMenu>
                  ...
                  <Pagination>
                    ...
                    {commentTotal > limit_comments && (
                      <PaginationItem
                        active={
                          (params.skip > 0 &&
                            params.skip + limit_comments < commentTotal) ||
                          (params.skip > 0 &&
                    ...
                    {commentTotal > limit_comments * 2 && (
                      <PaginationItem
                        active={params.skip + limit_comments >= commentTotal}
                      >
                        <PaginationLink
                          onClick={(e) =>
